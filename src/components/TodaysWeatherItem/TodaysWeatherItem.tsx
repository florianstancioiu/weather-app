...
const TodaysWeatherItem = ({
  ...
  return (
    <>
      {!isLoading && (
        <li className="p-[1.625rem] bg-background-2 rounded-[0.625rem] border-[2px] border-dark-blue dsktp:h-[7.5rem] dsktp:p-[1.25rem]">
      ...
      {isLoading && (
        <li className="p-[1.625rem] bg-background-2 rounded-[0.625rem] border-[2px] border-dark-blue h-[7.375rem] dsktp:h-[7.5rem] dsktp:p-[1.25rem]"></li>
      )}
    </>
  );
};
