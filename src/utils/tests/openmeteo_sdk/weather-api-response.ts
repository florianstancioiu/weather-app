...
import { Model } from '../openmeteo_sdk/model';
import { VariablesWithTime } from '../openmeteo_sdk/variables-with-time';
...
static addLocationId(builder:flatbuffers.Builder, locationId:flatbuffers.Long) {
  builder.addFieldInt64(4, locationId, builder.createLong(0, 0));
}
